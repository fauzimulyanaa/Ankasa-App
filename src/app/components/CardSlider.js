...
function Slider() {
  ...
  return (
    <div className="px-20 mt-36">
      ...
      <Swiper modules={[Pagination, Autoplay, EffectCoverflow]} slidesPerView={5} spaceBetween={20} autoplay={{ delay: 3000 }} pagination={{ el: ".swiper-pagination", clickable: true }} className="swiper_container  w-full">
